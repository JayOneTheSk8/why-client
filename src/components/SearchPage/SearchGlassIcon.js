...
const SearchGlassIcon = ({ classes }) => {
  return (
    <svg className={classes.searchGlassIcon} xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" viewBox="0 0 32 32" version="1.1" xmlSpace="preserve">
