...
const MoonIcon = ({ classes }) => {
  return (
    <svg className={classes.moonIcon} xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" viewBox="0 0 512.166 512.166">
      <g>
        <g>
...
export default withStyles(styles)(MoonIcon);
